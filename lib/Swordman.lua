...
self.ActionGroup = {
					stand ={snspeed = 3,startsn=177,endsn=180},
					...
					attack2 = {snspeed = 13,startsn=34,endsn=42,判定帧 = 36},
...
--					普攻3={snspeed = 8,startsn=200,endsn=204,下连激活 = false,判定帧 = 4},
  ...
  --====================提取npk信息========================================
  local npk_data =  {}
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_avatar_skin.NPK",npk_data)
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_avatar_belt.NPK",npk_data)
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_avatar_cap.NPK",npk_data)
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_avatar_coat.NPK",npk_data)
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_avatar_face.NPK",npk_data)
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_avatar_hair.NPK",npk_data)
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_avatar_neck.NPK",npk_data)
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_avatar_pants.NPK",npk_data)
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_avatar_shoes.NPK",npk_data)
  NPK.extract_npk_add("NPK/sprite_character_swordman_equipment_weapon_lkatana.NPK",npk_data)

  --===================end-提取npk信息========================================

	self.Avatar = {}
	self.Avatar[1] = 
    { place = "skin",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/skin/sm_body80100.img",npk_data)} 
  --[[
  self.Avatar[2] = 
    { place = "belt",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/belt/sm_belt0000a.img",npk_data)}
  self.Avatar[3] = 
    { place = "belt",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/belt/sm_belt0000b.img",npk_data)}
    
  self.Avatar[4] = 
    { place = "cap",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/cap/sm_cap0000c.img",npk_data)} 
  self.Avatar[5] = 
    { place = "coat",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/coat/sm_coat0000a.img",npk_data)} 
  self.Avatar[6] = 
    { place = "face",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/face/sm_face0200b.img",npk_data)} 
  self.Avatar[7] = 
    { place = "hair",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/hair/sm_hair0000a.img",npk_data)} 
  self.Avatar[8] = 
    { place = "neck",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/neck/sm_neck0000c.img",npk_data)} 
  self.Avatar[9] = 
    { place = "neck",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/neck/sm_neck0000d.img",npk_data)} 
    
  self.Avatar[10] = 
    { place = "pants",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/pants/sm_pants2103a.img",npk_data)} 
  self.Avatar[11] = 
    { place = "pants",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/pants/sm_pants2103b.img",npk_data)} 
    
  self.Avatar[12] = 
    { place = "shoes",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/shoes/sm_shoes0000a.img",npk_data)} 
  self.Avatar[13] = 
    { place = "shoes",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/avatar/shoes/sm_shoes0000b.img",npk_data)} 
    
    ]]
  self.Avatar[14] = 
    { place = "weapon",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/weapon/lkatana/lkatana0000b.img",npk_data)} 
  self.Avatar[15] = 
    { place = "weapon",sprpak = CC_SpriteIMG.new("sprite/character/swordman/equipment/weapon/lkatana/lkatana0000c.img",npk_data)} 
...
function Swordman:Updata(dt)
  ...
  for i=1,#self.Avatar do
	...
	--攻击检测碰撞盒
	self.AttackBox[1] = self.Avatar[14].sprpak.colliderbox
  self.AttackBox[2] = self.Avatar[15].sprpak.colliderbox
  self.AttackBox[3] = self.Avatar[1].sprpak.colliderbox
  
  self.BodyBox = self.Avatar[1].sprpak.colliderbox
...
function Swordman:Show(offx, offy)
  ...
  for i=1,#self.Avatar do
    ...
    for i=1,#self.AttackBox do
      self.AttackBox[i]:Show(red, offx, offy)
    end
	end

...
-- library info
loveframes.author = "love2d.org"
loveframes.version = "11.1"
loveframes.stage = "beta"

-- library configurations
loveframes.config = {}
loveframes.config["DIRECTORY"] = nil
loveframes.config["DEFAULTSKIN"] = "Orange"
loveframes.config["ACTIVESKIN"] = "dnf"
...
--增加中文支持
loveframes.fontPath="data/font/SourceHanSerifSC-Medium.otf"
if loveframes.fontPath then
	...
	loveframes.basicfontbig=love.graphics.newFont(15)
end
loveframes.objects = {}
